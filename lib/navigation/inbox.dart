...
class _InboxState extends State<Inbox> {
 ...
 Container(
              ...
              Container(
                      ...
                      SizedBox(
                        ...
                        height: MediaQuery.of(context).size.height/50,
                                ...
                                SizedBox(
                                  ...
                                  child:  Row(
                                    children: [
                                      ...
                                      const Icon(Icons.inbox, color: Colors.grey, size: 20,),
                                              SizedBox(
                                      width: MediaQuery.of(context).size.width/20,
                                ...
                                SizedBox(height: MediaQuery.of(context).size.height/50,),
                                const Divider(endIndent: 35, indent: 35, color:  Color.fromARGB(255, 207, 206, 206),),
          ...
          child: ElevatedButton(
            style:  ButtonStyle(
              backgroundColor: const MaterialStatePropertyAll(Color(0xFFF2F9F9)),
            ...
            child:  const Row(
              ...
              children: [
                Icon(Icons.add, color: Color(0xFF24A19C),),
                Text(' Add Sub-task',textAlign: TextAlign.center, style: TextStyle(color: Color(0xFF24A19C)),),
